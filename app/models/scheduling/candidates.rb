...
#
# Ranked by: no conflict, fewest assignments in the last 8 weeks, fewest recent
# declines, then longest since last serving. Phase 5 adds burnout load as a factor.
class Scheduling::Candidates
  LOOKBACK = 8.weeks

  Candidate = Data.define(:person, :recent_count, :recent_declines, :last_served_on, :conflicts) do
    ...
    def sort_key = [ conflict? ? 1 : 0, recent_count, recent_declines, last_served_on || Date.new(1900), person.last_name, person.first_name ]
  end
